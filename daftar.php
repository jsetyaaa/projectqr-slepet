                    ...
                    <form class="space-y-4 md:space-y-6" action="register.php" method="POST">
                        <div>
                            <label for="username" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Your
                                username</label>
                            <input type="username" name="username" id="username" class="w-60 md:w-96 p-3 border border-black" placeholder="username" required="">
                        </div>
                        <div>
                            <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Your
                                email</label>
                            <input type="email" name="email" id="email" class="w-60 md:w-96 p-3 border border-black" placeholder="nama@mail.com" required="">
                        </div>
                        <div>
                            <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Password</label>
                            <input type="password" name="password" id="password" placeholder="••••••••" class="w-60 md:w-96 p-3 border border-black" required="">
                        </div>
                        <button type="submit" class="w-60 md:w-96 bg-green-500 text-white p-3 rounded-md">Daftar Akun</button>
